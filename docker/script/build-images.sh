...
sudo sed -i "s/3315/${PORT_PROXY_MYSQL_ORCH}/g" `grep 3315 -rl example-core/example-api/`
sudo sed -i "s/3316/${PORT_PROXY_PG_ORCH}/g" `grep 3316 -rl example-core/example-api/`
